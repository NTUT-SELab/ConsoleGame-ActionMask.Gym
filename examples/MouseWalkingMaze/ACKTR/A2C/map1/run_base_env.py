...
model = ACKTR(CustomCnnLnLstmPolicy, env, verbose=0, tensorboard_log=tensorboard_folder)
...
model.save(model_folder + "ACKTR_A2C_CnnLnLstm" + model_tag)
del model
model = ACKTR.load(model_folder + "ACKTR_A2C_CnnLnLstm" + model_tag)
